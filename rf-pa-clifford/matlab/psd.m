...
%   $Revision: 1.12.4.7 $  $Date: 2009/05/23 08:13:38 $
...
% warning(generatemsgid('PSDisObsolete'),['PSD has been replaced by SPECTRUM ',... 
% 'objects. PSD still works but may be removed in the future. ',...
...
if (nargout == 3) || ((nargout == 0) && ~isempty(p)),
    ...
    if noverlap > 0
        warning(generatemsgid('InaccurateResult'),...
            'Confidence intervals inaccurate for NOVERLAP > 0.');
    end
end
